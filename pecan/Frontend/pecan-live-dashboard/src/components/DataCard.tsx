...
function DataCard({
    ...
    const menuItems = collapsed
        ? ["Add to Favourites", "br", "Expand"]
        : ["Add to Favourites", "br", "Collapse"];
        ...
        try {
            const parsed =
                typeof incoming === "string"
                    ? (JSON.parse(incoming) as DataPair[])
                    : incoming;

            if (!Array.isArray(parsed)) {
                console.error(
                    "populateDataColumns: expected array of single-key objects"
                );
                return;
            }
    ...
    return (
        ...
        <div className="min-w-[400px] max-w-[440px] w-100">
            ...
            <div
                className={`${
                    collapsed ? "gap-0.5" : "gap-1.5"
                } grid grid-cols-6 box-border mx-[3px]`}
            >
                {/* Message ID Button */}
                <Dropdown
                    items={menuItems}
                ...
                >
                    <div
                        className={`${
                            collapsed
                                ? "rounded-l-lg bg-data-textbox-bg"
                                : "rounded-t-md bg-data-module-bg"
                        } col-span-1 h-[40px] mx-[0px] w-100 box-border flex justify-center items-center cursor-pointer`}
                    >
                ...
                <div
                    ...
                    } col-span-3 h-[40px] mx-[0px] box-border bg-data-module-bg flex justify-center items-center hover:brightness-110 transition`}
                >
                    <button
                        type="button"
                        onClick={toggleCollapsed}
                        className={`h-[40px] mx-[0px] box-border bg-data-module-bg flex justify-center items-center`}
                    >
                ...
                <div
                    className={`${
                        collapsed ? "rounded-r-lg" : "rounded-t-md"
                    } col-span-2 h-[40px] mx-[0px]  box-border flex justify-center items-center
                        ${
                            computedCategory === "VCU"
                                ? "bg-sky-400"
                                : computedCategory === "INV"
                                ? "bg-green-400"
                                : computedCategory === "CAT2"
                                ? "bg-sky-500"
                                : computedCategory === "BMS/TORCH"
                                ? "bg-orange-400"
                                : computedCategory === "CAT4"
                                ? "bg-red-500"
                                : "bg-blue-500"
                        }`} // Default
            ...
            <div
                ...
                className={[
                    ...
                    collapsed
                        ...
                        : "p-[10px] max-h-[1000px] opacity-100",
                ].join(" ")}
            ...
            >
                ...
                <div className="h-[50px] grid grid-cols-6 text-white text-xs items-center justify-start">
                    <p id="raw-data" className="col-span-4 font-semibold">
                        &nbsp;&nbsp;&nbsp;{rawData || "00 01 02 03 04 05 06 07"}
                    </p>
                    <p
                        id="raw-data-received"
                        className="col-span-2 text-end font-semibold"
                    >
